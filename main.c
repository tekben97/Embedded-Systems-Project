#include <msp430.h>
#define CALADC_15V_30C  *((unsigned int *)0x1A1A)                 // Temperature Sensor Calibration-30C //6682                                                                 // See device datasheet for TLV table memory mapping //6684
...
void ConfigureAdc_temp(){
            ...
            ADCMCTL0 |= ADCSREF_1 | ADCINCH_2;                           // ADC input ch A12 => temp sense
            ADCIE |=ADCIE0;
}
// Configure ADC Humidity
void ConfigureAdc_humid(){
        ADCCTL0 &= ~ADCENC;
        ADCCTL0 |= ADCSHT_8 | ADCON;                                  // ADC ON,temperature sample period>30us
